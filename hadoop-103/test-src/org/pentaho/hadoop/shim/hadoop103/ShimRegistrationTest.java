...
package org.pentaho.hadoop.shim.hadoop103;
...
public class ShimRegistrationTest {
  ...
  public void hadoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.hadoop103.HadoopShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void snappyShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.hadoop103.SnappyShim.class.isAssignableFrom(s.getClass()));
  }
